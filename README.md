...
[![npm](https://img.shields.io/npm/v/@janvitos/pi-usage)](https://www.npmjs.com/package/@janvitos/pi-usage) [![Pi extension](https://img.shields.io/badge/Pi-extension-blue)](https://pi.dev) [![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](./LICENSE)
...
```bash
pi install npm:@janvitos/pi-usage
```

Try without installing permanently:

```bash
pi -e npm:@janvitos/pi-usage
```
...
After the active runtime credential changes, the next command, turn, or lifecycle refresh resolves auth again and cannot reuse another account's cached report.
...
- Immediate account-change events are not available from Pi; auth is re-resolved before commands, turns, and lifecycle refreshes.
